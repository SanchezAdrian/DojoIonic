...
@Component({
  selector: 'app-maestro-sin-examen',
  templateUrl: './maestro-sin-examen.page.html',
  styleUrls: ['./maestro-sin-examen.page.scss'],
})
export class MaestroSinExamenPage implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.nav.navigateForward['/selector-maestro'];
  }
  ...
  asignar(id: string) { //empieza un examen para el alumno asignando sus partes
